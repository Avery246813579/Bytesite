...
setcookie('LAST_PAGE', 'http://www.roflgator.net/admin/perks.php', time() + 60 * 60 * 24 * 365 * 2);
                ...
                <div class="col-md-6">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">New Perk</h3>
                        </div>

                        <form action="../AdminAction.php" role="form" method="post">
                            <div class="box-body">
                                <div class="form-group">
                                    <label for="name">Perk Name</label>
                            ...
                            <input type="hidden" name="ActionType" value="NewPerk">
                            <input type="hidden" name="ReturnPage" value="http://www.roflgator.net/admin/perks.php">
                            ...
                            if (is_array($perks)) {
                                foreach ($perks as $values) {
                                    if ($values instanceof Perks) {
                                        echo ' <tr >
                                            <td><a href="../AdminAction.php?id=' . $values->perk_id . '&type=DeletePerk&back=perks.php"><button class="btn btn-default btn-sm"><i class="fa fa-trash-o"></i></button></a></td>
