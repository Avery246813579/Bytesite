...
<head>
    <meta charset="UTF-8">
    <title>Roflgator | Item Types</title>
                ...
                <div class="col-md-6">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">New Item Type</h3>
                        </div>
                        ...
                        <form action="../AdminAction.php" role="form" method="post">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label>Can Use</label>
                                    <select name="can_use" class="form-control">
                            ...
                            <input type="hidden" name="ActionType" value="NewItemType">
                            <input type="hidden" name="ReturnPage" value="http://www.roflgator.net/admin/item_types.php">
                ...
                <div class="col-md-6">
                    <div class="box box-primary">
                        ...
                        <div class="box-body no-padding">
                            <?php
                            $sql_handler = new SqlHandler();
                            $types = $sql_handler->get_item_types();
                            ...
                            if (is_array($types)) {
                                foreach ($types as $values) {
                                    if ($values instanceof Item_Type) {
                                        echo ' <tr >
                                            <td><a href="../AdminAction.php?id=' . $values->type_id . '&type=DeleteItemType&back=item_types.php"><button class="btn btn-default btn-sm"><i class="fa fa-trash-o"></i></button></a></td>
                                            <td> ' . $values->name . ' </td >
                                            <td>' . $values->description . '</td >
                                            <td>' . $values->can_use . '</td >
                                        </tr >';
                                    }
                                }
                            }
