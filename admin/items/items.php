...
require_once('../../twitch/TwitchHandler.php');
...
setcookie('LAST_PAGE', 'http://www.roflgator.net/admin/items.php', time() + 60 * 60 * 24 * 365 * 2);
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="http://www.roflgator.net/admin/items.php"><i class="fa fa-circle-o"></i> Items</a>
                        </li>
                    ...
                    <div class="box box-primary">
                        ...
                        <form action="../AdminAction.php" role="form" method="post">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label for="gph">GPH</label>
                                    <input type="number" class="form-control" name="gph" placeholder="69">
                                </div>
                                ...
                                $perks = $sql_handler->get_perks();
                                echo '<div class="form-group">
                                    <label>Perks</label>';

                                if (is_array($perks)) {
                                    echo '<select name = "perks" multiple class="form-control" >';

                                    foreach ($perks as $values) {
                                        if ($values instanceof Perks) {
                                            echo '<option value="' . $values->perk_id . '">' . $values->name . '</option>';
                                        }
                                    }
                                    echo '</select >';
                                }
                                ...
                                <div class="form-group">
                                    <label>Quality</label>
                                    <select name="quality" multiple class="form-control">';

                                if (is_array($qualities)) {
                                    foreach ($qualities as $values) {
                                        if ($values instanceof Qualities) {
                                            echo '<option value="' . $values->quality_id . '">' . $values->name . '</option>';
                                        }
                                    }
                                }
                                ...
                                $item_types = $sql_handler->get_item_types();
                                echo '<div class="form-group">
                                    <label>Item Type</label>
                                    <select name="type" class="form-control">';

                                if (is_array($item_types)) {
                                    foreach ($item_types as $values) {
                                        if ($values instanceof Item_Type) {
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="url" class="form-control" name="image" placeholder="Item Image">

                                    <p class="help-block">Try to shorten the link!</p>
                                </div>
                            </div>
                            ...
                            <input type="hidden" name="ActionType" value="NewItem">
                            <input type="hidden" name="ReturnPage" value="http://www.roflgator.net/admin/items.php">
                        </form>
                                ...
                                if (is_array($items)) {
                                    foreach ($items as $values) {
                                        if ($values instanceof Items) {
                                            echo ' <tr >
                                            <td><a href="../AdminAction.php?id=' . $values->item_id . '&type=DeleteItem&back=items/items.php"><button class="btn btn-default btn-sm"><i class="fa fa-trash-o"></i></button></a>
                                            <a href="../AdminAction.php?id=' . $values->item_id . '&type=DeleteItem&back=items/items.php"><button class="btn btn-default btn-sm"><i class="fa fa-edit"></i></button></a></td>
                                            <td> ' . $values->name . ' </td >
                                            <td>' . $values->description . '</td >
                                            <td>' . $values->gph . '</td >
                                            <td>' . $values->item_type . '</td >
                                            <td>' . $values->perk_ids . '</td >
                                            <td>' . $values->quality . '</td >
                                            <td>' . $values->item_image . '</td >
                                        </tr >';
                                        }
                                    }
                                }
