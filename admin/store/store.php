...
setcookie('LAST_PAGE', 'http://www.roflgator.net/admin/store/store.php', time() + 60 * 60 * 24 * 365 * 2);
                ...
                <div class="col-md-6">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">New Store Item</h3>
                        </div>
                        ...
                        <form action="../AdminAction.php" role="form" method="post">
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <select name="item" class="form-control">
                                        <?php
                                        if(is_array($sql_handler->get_items())) {
                                            foreach ($sql_handler->get_items() as $values) {
                                                if ($values instanceof Items) {
                                                    echo '<option value="' . $values->item_id . '">' . $values->name . '</option>';
                                                }
                                            }
                                        }else{
                                            echo '<option> Create a item </option>';
                                        }
                                        ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="category" class="form-control">
                                        <?php
                                        if(is_array($sql_handler->get_categories(0))) {
                                            foreach ($sql_handler->get_categories(0) as $values) {
                                                if ($values instanceof Category) {
                                                    echo '<option value="' . $values->category_id . '">' . $values->name . '</option>';
                                                }
                                            }
                                        }else{
                                            echo '<option> Create a Category </option>';
                                        }
                                        ?>
                                    </select>
                                </div>
                            ...
                            <input type="hidden" name="ActionType" value="NewStore">
                            <input type="hidden" name="ReturnPage" value="http://www.roflgator.net/admin/store/store.php">
                ...
                <div class="col-md-6">
                    <div class="box box-primary">
                        ...
                        <div class="box-body no-padding">
                            ...
                            if (is_array($stores)) {
                                foreach ($stores as $values) {
                                    if ($values instanceof Store) {
                                        echo ' <tr >
                                            <td><a href="../AdminAction.php?id=' . $values->store_id . '&type=DeleteStore&back=store/store.php"><button class="btn btn-default btn-sm"><i class="fa fa-trash-o"></i></button></a></td>
                                            <td> ' . $sql_handler->get_category($values->category)->name . ' </td >
                                            <td> ' . $sql_handler->get_item($values->item)->name . '</td >
                                            <td> ' . $values->price . '</td >
                                        </tr >';
                                    }
                                }
