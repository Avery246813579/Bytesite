...
setcookie('LAST_PAGE', 'http://www.roflgator.net/admin/store/purchases.php', time() + 60 * 60 * 24 * 365 * 2);
...
<head>
    <meta charset="UTF-8">
    <title>Roflgator | Purchases</title>
                ...
                <div class="col-md-12">
                    <div class="box box-primary">
                        ...
                        <div class="box-body no-padding">
                            <?php
                            $sql_handler = new SqlHandler();
                            $purchases = $sql_handler->get_purchases();
                            ...
                            if (is_array($purchases)) {
                                foreach ($purchases as $values) {
                                    if ($values instanceof Purchases) {
                                        echo ' <tr >
                                            <td> ' . $values->purchase_id . ' </td >
                                            <td> ' . $values->account_id . ' </td >
                                            <td> ' . $values->item_bought . ' </td >
                                            <td> ' . $values->cost . ' </td >
                                            <td> ' . $values->time . ' </td >
                                            <td> ' . $values->email . ' </td >
                                            <td> ' . $values->paypal_id . ' </td >
                                        </tr >';
                                    }
                                }
                            }
