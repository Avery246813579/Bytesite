...
setcookie('LAST_PAGE', 'http://www.roflgator.net/admin/store/category.php', time() + 60 * 60 * 24 * 365 * 2);
...
<head>
    <meta charset="UTF-8">
    <title>Roflgator | Category</title>
                ...
                <div class="col-md-6">
                    <div class="box box-primary">
                        ...
                        <form action="../AdminAction.php" role="form" method="post">
                            ...
                            <input type="hidden" name="ActionType" value="NewStoreCategory">
                            <input type="hidden" name="ReturnPage" value="http://www.roflgator.net/admin/store/category.php">
                ...
                <div class="col-md-6">
                    <div class="box box-primary">
                        ...
                        <div class="box-body no-padding">
                            <?php
                            $sql_handler = new SqlHandler();
                            $categories = $sql_handler->get_categories(0);
                            ...
                            if (is_array($categories)) {
                                foreach ($categories as $values) {
                                    if ($values instanceof Category) {
                                        echo ' <tr >
                                            <td><a href="../AdminAction.php?id=' . $values->category_id . '&type=DeleteStoreCategory&back=store/category.php"><button class="btn btn-default btn-sm"><i class="fa fa-trash-o"></i></button></a></td>
